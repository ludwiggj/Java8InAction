...
public class PartitionPrimeNumbers {
  ...
  public static Predicate<Integer> isPrimeTake1 = candidate ->
      IntStream.range(2, candidate).noneMatch(i -> candidate % i == 0);

  public static Predicate<Integer> isPrimeTake2= candidate -> {
    int candidateRoot = (int) Math.sqrt((double) candidate);
    return IntStream.rangeClosed(2, candidateRoot)
        .noneMatch(i -> candidate % i == 0);
  };

  public static Predicate<Integer> isPrimeTake3 = candidate -> {
